...
def VCTScraper(vctLink, year, upcomingEvent=[]):
    ...
    #         # print(urlMatch) # Checking if the URL is correct
            ...
            # for matchPlayer in queryMatchPlayers: # For each players in the match
            ...
            print(f"{teamNameLst} {matchInfo} {mapLst} {playersLst}, {matchDateTimeFinal}")
    ...
    #                 statSidedLst[countStat].append(matchDateTimeNew)
    ...
    #                 tempLst.append(statSidedLst[countStatSided_imp][-2]) # Name
    #                 tempLst.append(urlMatch) # Datetime
    #                 tempLst.append(matchDateTimeNew)
    #                 # print(tempLst)
    #                 # statSidedLstImp.append(tempLst)
    #                 statSidedLst_imp.append(tempLst)
    #                 print("statSidedLst_imp: ", len(statSidedLst_imp))
    ...
    #                 playersLst[countPlayerStat].append(matchDateTimeNew)
